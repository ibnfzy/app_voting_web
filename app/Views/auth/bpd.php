  ...
  <div class="login-box">
    <div class="card card-outline card-primary">
      <div class="card-header"> <a href="#"
          ...
          <h1 class="mb-0"> <b>Login BPD</b>
          </h1>
        </a> </div>
      <div class="card-body login-card-body">
        <form action="/Auth/BPD" method="post">
          <div class="input-group mb-1">
            <div class="form-floating"> <input id="username" type="text" class="form-control" placeholder=""
                name="username">
