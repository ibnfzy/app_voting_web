          ...
          <?php foreach ($data as $key => $item) : ?>
            <tr>
              ...
              <td>
                ...
                <a href="/BPDPanel/Calon/<?= $item['id_candidate'] ?>" class="btn btn-danger">Hapus</a>
              </td>
            </tr>
          <?php endforeach ?>
        </tbody>
...
<div class="modal fade" id="tambah" tabindex="-1" aria-labelledby="tambahLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="/BPDPanel/Calon" method="post" enctype="multipart/form-data">
...
<div class="modal fade" id="edit" tabindex="-1" aria-labelledby="editLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="/BPDPanel/Calon/Update" method="post" enctype="multipart/form-data">
