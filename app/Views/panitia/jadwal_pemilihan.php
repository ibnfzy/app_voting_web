...
<div class="container mt-4">
  <div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
      ...
      <a class="btn btn-primary" href="<?= base_url('PanitiaPanel/prosesPemilihan'); ?>">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center">
              ...
              <a class="btn btn-sm btn-primary" href="<?= base_url('PanitiaPanel/Laporan/' . $schedule['id_schedule']); ?>"
                target="_blank">
